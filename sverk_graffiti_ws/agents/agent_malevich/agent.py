...
class MalevichAgent(ArtAgent):
    """Агент в стиле Малевича - супрематизм, геометрические формы"""

    def __init__(self):
        super().__init__('malevich', 'супрематист')
    ...
    def generate_proposals_from_prompt(self, prompt: str) -> List[str]:
        ...
        if 'супрематизм' in prompt_lower or 'геометри' in prompt_lower:
            proposals = ['Чёрный квадрат', 'Красный квадрат', 'Супрематическая композиция']
        elif 'минимал' in prompt_lower or 'простой' in prompt_lower:
            proposals = ['Чёрный квадрат', 'Белое на белом']
        elif 'цвет' in prompt_lower or 'яркий' in prompt_lower:
            proposals = ['Красный квадрат', 'Супрематическая композиция']
        else:
    ...
    def generate_argument(self, proposal):
        args = {
            'Чёрный квадрат': 'Ноль форм. Абсолютное искусство!',
            'Красный квадрат': 'Красный цвет — революция живописи!',
            'Чёрный круг': 'Совершенная геометрическая форма!',
            'Супрематическая композиция': 'Динамика чистых форм!',
            'Белое на белом': 'Бесконечность в простоте!'
        }
        return args.get(proposal, 'Геометрия — основа всего!')
